...
/** Deletes the record by its session identifier. | Tool: Vendor_DeleteById */
export async function Vendor_DeleteById(input = {}) {
  return callMCPTool('Vendor_DeleteById', input);
}
